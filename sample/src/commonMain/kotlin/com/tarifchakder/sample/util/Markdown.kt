package com.tarifchakder.sample.util
...
val markDownText = """
   ...
   kotlin {
       sourceSets {
           commonMain {
               dependencies {
                   implementation("com.tarifchakder.materializekmp:material-theme:0.0.1")
               }
           }
       }
   }
   ...
   [libraries]
   materialKolor = { module = "com.tarifchakder.materializekmp", version.ref = "materialtheme" }
   ```
