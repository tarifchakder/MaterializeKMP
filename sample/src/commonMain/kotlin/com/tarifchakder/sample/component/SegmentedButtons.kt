...
fun SegmentedButtonItem(
    ...
    val animationProgress: Float by animateFloatAsState(
        ...
        animationSpec = tween(SegmentedButtonsDefaults.ITEM_ANIMATION_MILLIS), label = "SegmentedButton"
    )
...
data class SegmentedButtonColors internal constructor(
    ...
    internal fun textColor(selected: Boolean): State<Color> {
        ...
        return animateColorAsState(
            ...
            animationSpec = tween(SegmentedButtonsDefaults.ITEM_ANIMATION_MILLIS),
    ...
    fun SegmentedDivider(
        modifier: Modifier = Modifier,
        thickness: Dp = SegmentedButtonsDefaults.outlineThickness,
